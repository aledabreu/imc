...
function imc () {
    ...
    if (nome !== '' && altura !== '' && peso !== '') {
        ...
        resultado.textContent = `Olá, ${nome}! Com ${peso}kg e ${altura}m, seu IMC é ${valorIMC}. Atualmente, você está ${classificacao}. Seu peso ideal está entre ${ideal1}kg e ${ideal2}kg`;
